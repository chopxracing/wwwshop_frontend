            ...
            if ($("#price-range").length) {
              $("#price-range").slider({
                ...
                slide: function (event, ui) {
                  $("#priceRange").val("Руб." + ui.values[0] + " - Руб." + ui.values[1]);
                }
              });
              $("#priceRange").val("Руб. " + $("#price-range").slider("values", 0) + " - Руб. " + $("#price-range").slider("values", 1));
            }
                    ...
                    <div
                      ...
                      <div class="short-by">
                        <div class="select-box">
                          <select class="wide">
                            <option value="1" data-display="Short by latest">Featured</option>
              ...
              <div class="row" v-if="pagination?.last_page > 1">
                <div class="col-12 d-flex justify-content-center wow fadeInUp animated">
                  <ul class="pagination text-center">
                    <li v-if="pagination && pagination.current_page != 1" class="next">
                    ...
                    <li v-if="pagination && pagination.current_page != pagination.last_page" class="next">
